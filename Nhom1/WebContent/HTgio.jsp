  ...
  <div class="container-fluid">  
	...
	<ul class="nav navbar-nav navbar-right">
      <li><a href="#"><span class="glyphicon glyphicon-user"></span> Đăng ký</a></li>
		<% khachhangbean kh=(khachhangbean)session.getAttribute("dn");	// tạo kh = biến session dn (đăng nhập) - đã tạo ở KTDN.jsp
		if(kh!=null){		   
		%>
		...
		<%}else{ %>
			...
			<%}%> <%//1bug sau khi dn sai, vi da chuyen sang trang KTDN va tao bien dn nen khi load trang lai se hien len thong bao nay %>
		<%}%>
    </ul>
</div>
</nav>
			...
			for(GioHangbean g1: gh1.ds){%>
				<tr>
					...
					<td width="50px" height="50px">
						<img src=image_sach/<%=sbo.TimAnh(ds1, g1.getMasach())%> width="100%" >
					</td>
					
					<td valign="bottom">
						<%out.print(g1.getMasach() +":"+g1.getTensach());%><br>
						<br>
					<form method="post" action="EditSach.jsp">
						...
						<input name="sub0" value="Cập nhật" type="submit"> 
						<input name="sub1" value="Xoá" type="submit">
					</form>
